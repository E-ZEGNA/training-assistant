...
contextBridge.exposeInMainWorld('interviewAPI', {
  ...
  setProvider: (configuration) => ipcRenderer.invoke('provider:set', configuration),
  clearProvider: () => ipcRenderer.invoke('provider:clear'),
  getProviderModels: () => ipcRenderer.invoke('provider:models'),
  openXiaomuai: () => ipcRenderer.invoke('provider:open-xiaomuai'),
